...
def aggiusta_nome (nome):
    ...
    if "%3A" in nome:
        ...
        return nome_file_scaricato
    if "%21" in nome:
        nome_file_scaricato = nome.replace("%21", "!")
        return nome_file_scaricato
    return nome
...
def run ():
    ...
    for url in urll:
        ...
        dir = "/home/"+name+"/anime/" + str(title.replace("\n", ""))
        ...
        for i in tqdm (range (1, pages+1)):
            ...
            while not exists("/home/"+name+"/Downloads/" + nome_file_scaricato ): 
                time.sleep(5)
            ...
            try:
                shutil.move("/home/"+name+"/Downloads/" + nome_file_scaricato , dir)
                time.sleep(1)
            except:
                # se è già presente, la elimito dalla cartella downloads
                os.system("rm " + "/home/"+name+"/Downloads/" + nome_file_scaricato)
