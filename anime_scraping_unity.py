...
def run ():
    ...
    for url in urll:
        ...
        dir = "/home/ricca/anime/" + str(title.replace("\n", ""))
        ...
        for i in tqdm (range (1, pages+1)):
            ...
            while not exists("/home/ricca/Downloads/" + nome_file_scaricato ):
                time.sleep(5)
            ...
            try:
                shutil.move("/home/ricca/Downloads/" + nome_file_scaricato , dir)
                time.sleep(1)
            except:
                os.system("rm " + "/home/ricca/Downloads/" + nome_file_scaricato)
